...
public class RtmpClient {
     ...
     * @throws IOException if connection is not opened or connection to server is lost
     */
    public int write(byte[] data,long size,int time) throws IOException {
        return nativeWrite(data, size,rtmpPointer,time);
    }

    private native int nativeWrite(byte[] data,long size, long rtmpPointer,int time) throws IOException;
